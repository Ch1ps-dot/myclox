...
// display invoke instruction
static int 
invokeInstruction(const char* name, Chunk* chunk,
                                int offset) {
  uint8_t constant = chunk->code[offset + 1];
...
// display the instruction and stack information
static 
byteInstruction(const char* name, Chunk* chunk,
                           int offset) {
...
// dispaly jump instruction
static int 
jumpInstruction(const char* name, int sign,
